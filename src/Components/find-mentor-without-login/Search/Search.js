...
function Search() {
  ...
  return (
    <div>
      <div className='find-mentor'>Find a mentor</div>
      <div className='search'>
        <div className='inputs'>
          ...
          <div className='search-element last-ele'>
      ...
      <div className='button1'>
        <button onClick={(e) => search()} className='button-search'>
          Search
        </button>
      </div>
      <div className='top-mentors'>Top Mentors</div>
